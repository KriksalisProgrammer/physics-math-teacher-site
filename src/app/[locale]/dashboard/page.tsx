...
export default function DashboardPage() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 py-12">
          <div className="max-w-6xl mx-auto">
              ...
              {[
                {
                  ...
                  title: dictionary.dashboard?.feature_lessons || 'Персональні уроки',
                  desc: dictionary.dashboard?.feature_lessons_desc || 'Записуйтесь на уроки та слідкуйте за своїм прогресом',
                  gradient: 'from-blue-400 to-cyan-400',
                  bgGradient: 'from-blue-50 to-cyan-50'
                },
                {
                  icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z",
                  title: dictionary.dashboard?.feature_progress || 'Відстеження прогресу',
                  desc: dictionary.dashboard?.feature_progress_desc || 'Аналізуйте свої досягнення та статистику навчання',
                  gradient: 'from-green-400 to-emerald-400',
                  bgGradient: 'from-green-50 to-emerald-50'
                },
                {
                  icon: "M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4",
                  title: dictionary.dashboard?.feature_settings || 'Персональні налаштування',
                  desc: dictionary.dashboard?.feature_settings_desc || 'Налаштуйте профіль та уподобання під себе',
                  gradient: 'from-purple-400 to-pink-400',
                  bgGradient: 'from-purple-50 to-pink-50'
                }
              ].map((feature, index) => (
                <div key={index} className="group transform transition-all duration-500 hover:scale-105">
                  <div className={`backdrop-blur-sm bg-gradient-to-br ${feature.bgGradient} rounded-3xl p-8 shadow-xl border border-white/50 hover:shadow-2xl transition-all duration-300`}>
                    <div className={`w-16 h-16 bg-gradient-to-r ${feature.gradient} rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:rotate-12 transition-transform duration-300`}>
            ...
            {/* Statistics Preview */}
            <div className="backdrop-blur-sm bg-white/30 rounded-3xl p-8 mb-16 border border-white/40 shadow-2xl">
              <h2 className="text-3xl font-bold text-center text-gray-800 mb-8">
                {dictionary.dashboard?.platform_stats || 'Статистика платформи'}
              </h2>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {[
                  { number: '2,500+', label: dictionary.dashboard?.happy_students || 'Щасливих студентів', icon: '👨‍🎓' },
                  { number: '50+', label: dictionary.dashboard?.expert_teachers || 'Експертних викладачів', icon: '👩‍🏫' },
                  { number: '10,000+', label: dictionary.dashboard?.lessons_completed || 'Проведених уроків', icon: '📚' },
                  { number: '98%', label: dictionary.dashboard?.success_rate || 'Рівень успішності', icon: '🎯' }
                ].map((stat, index) => (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="group backdrop-blur-sm bg-gradient-to-br from-orange-50 to-red-50 rounded-3xl p-8 border border-white/50 shadow-xl hover:shadow-2xl transform transition-all duration-300 hover:scale-105">
                <div className="flex items-center mb-6">
                  ...
                  </div>                  <h3 className="text-2xl font-bold text-gray-800">
                    Подати заявку
                  </h3>
                </div>
                ...
                <Link href={`/${locale}/applications`}>
                  <Button className="group/btn w-full bg-gradient-to-r from-orange-400 to-red-400 hover:from-orange-500 hover:to-red-500 text-white py-4 rounded-xl font-semibold shadow-lg transform transition-all duration-300 hover:scale-105">
                    <span className="flex items-center justify-center">                      <svg className="w-5 h-5 mr-2 group-hover/btn:rotate-12 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                      </svg>
                      Подати заявку
                    </span>
  ...
  const getStatusBadge = () => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 overflow-hidden">
      ...
      <div className="relative z-10 backdrop-blur-sm bg-white/30 border-b border-white/20 shadow-lg">
      ...
      </div>      <div className="relative z-10 container mx-auto px-4 py-8">
        {/* Stats Cards with Glassmorphism */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">          <div className="group transform transition-all duration-300 hover:scale-105">
        ...
        </div>        {/* Main Content with Glassmorphism */}
                          ...
                          <div className="ml-6">
                            <Link href={`/${locale}/lessons/${lesson.id}`}>
                              <Button className="group relative overflow-hidden bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-6 py-3 rounded-xl font-semibold shadow-lg transform transition-all duration-300 hover:scale-105">
                                ...
                                </span>                                <div className="absolute inset-0 bg-gradient-to-r from-purple-600 to-pink-600 opacity-0 transition-opacity duration-300 group-hover:opacity-100"></div>
                              </Button>
                            </Link>
                          </div>
                        )}
